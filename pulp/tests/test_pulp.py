        ...
        def test_unbounded(self):
            ...
            if self.solver.name in ["GUROBI", "CPLEX_CMD", "YAPOSIB", "MOSEK", "COPT"]:
                ...
                pulpTestCheck(
                    prob,
                    self.solver,
                    [const.LpStatusInfeasible, const.LpStatusUnbounded, const.LpStatusUndefined],
                )
                ...
                pulpTestCheck(prob, self.solver, [const.LpStatusNotSolved, const.LpStatusUndefined])
                ...
                pulpTestCheck(prob, self.solver, [const.LpStatusUnbounded, const.LpStatusUndefined])
